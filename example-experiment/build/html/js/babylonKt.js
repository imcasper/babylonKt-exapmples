define(['exports', 'kotlin', 'babylonjs'], function (_, Kotlin, $module$babylonjs) {
  ...
  function IInspectorOptions(embedMode, enableClose, enablePopup, explorerExtensibility, globalRoot, handleResize, initialTab, inspectorURL, overlay, showExplorer, showInspector) {
    if (embedMode === void 0)
      embedMode = null;
    if (enableClose === void 0)
      enableClose = null;
    if (enablePopup === void 0)
      enablePopup = null;
    if (explorerExtensibility === void 0)
      explorerExtensibility = null;
    if (globalRoot === void 0)
      globalRoot = null;
    if (handleResize === void 0)
      handleResize = null;
    if (initialTab === void 0)
      initialTab = null;
    if (inspectorURL === void 0)
      inspectorURL = null;
    if (overlay === void 0)
      overlay = null;
    if (showExplorer === void 0)
      showExplorer = null;
    if (showInspector === void 0)
      showInspector = null;
    this.embedMode = embedMode;
    this.enableClose = enableClose;
    this.enablePopup = enablePopup;
    this.explorerExtensibility = explorerExtensibility;
  ...
  IInspectorOptions.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'IInspectorOptions',
    interfaces: []
  };
  ...
  package$BABYLON.IInspectorOptions = IInspectorOptions;
